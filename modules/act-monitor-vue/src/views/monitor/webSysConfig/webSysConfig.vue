<template>
    <section>
        <div slot="footer" class="dialog-footer" >
            <el-button type="success" @click.native="issuedInstructions" :loading="issuedInstructionsLoading"><i class="el-icon-caret-bottom"></i> 下发  </el-button>
            <el-button type="primary" @click="instructionsInfo">上次下发详情</el-button>
            <el-button type="success" @click.native="resetSubmit" :loading="resetLoading"><i class="fa fa-reply fa-lg"></i> 还原</el-button>
            <el-button type="primary" @click.native="updateSubmit" :loading="updateLoading"><i class="fa fa-cog fa-lg"></i> 保存配置 </el-button>
        </div>
        <div>
            <el-col>
...
<script>
    import {initialize, resetConfig, updateConfig, issuedInstructions, instructionsInfo} from './webSysConfig.api'
