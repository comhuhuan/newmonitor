<template>
    <section>
        <div slot="footer" class="dialog-footer">
            ...
            <!--</el-button>-->
            <!--&lt;!&ndash;<el-button type="primary" @click.native="updateSubmit" :loading="updateLoading"><i&ndash;&gt;-->
            <!--&lt;!&ndash;class="fa fa-cog fa-lg"></i> ...&ndash;&gt;-->
...
<script>
    import {initialize, resetConfig, updateConfig, issuedInstructions, instructionsInfo} from './alarmSysConfig.api'
