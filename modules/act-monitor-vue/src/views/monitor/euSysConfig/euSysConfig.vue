        ...
        <el-form :model="sysForm" ref="sysForm" label-position="right" label-width="350px" label-suffix=":">
            ...
            <el-row v-for="(item,index) in sysForm.sysList" :key="index">
                ...
                <el-form-item :prop="'sysList.' + index + '.configval'" :label="item.title"
                    ...
                    <el-input class="el-input-ll" width="11" v-model="item.configval" size="small" :placeholder="item.defaultval">
                    </el-input>
                </el-form-item>
...
<script>
    import {initialize, resetConfig, updateConfig, issuedInstructions, instructionsInfo} from './euSysConfig.api'
