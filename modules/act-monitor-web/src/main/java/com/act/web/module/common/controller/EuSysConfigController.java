...
@Controller
@RequestMapping("/common/euSysConfig")
public class EuSysConfigController extends BaseController {
    private final Logger log = LoggerFactory.getLogger(EuSysConfigController.class);
    ...
    @Resource
    private EuSysConfigService euSysConfigService;
    ...
    public Object initialize() {
        try {
            List<SystemConfigVo> result = euSysConfigService.initialize();
    ...
    public Object updateConfig(ConfigsVo sysList) {
        String result = "";
        try {
            euSysConfigService.updateConfig(sysList);
            euSysConfigService.evictConfig(LOAD_CONFIG);
            return ajax(Status.success, result);
        } catch (Exception e) {
    ...
    public Object resetConfig() {
        String result = "";
        try {
            euSysConfigService.resetConfig();
            euSysConfigService.evictConfig("loadEuConfig");
            return ajax(Status.success, result);
        } catch (Exception e) {
